...
namespace SistemaAgendamentoCRUD.Controllers
{
    public class AgendamentosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Agendamentos.Include(a => a.Servico).Include(a => a.Usuario);
        ...
        {
            // Alterado de "Id" para "Nome" para exibir o nome na tela
        ...
        public async Task<IActionResult> Create([Bind("Id,DataHora,UsuarioId,ServicoId")] Agendamento agendamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataHora,UsuarioId,ServicoId")] Agendamento agendamento)
        {
